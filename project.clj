(defproject park "0.1.0-SNAPSHOT"

  :description "Support sharing of parking spots by building residents."
  :url "https://github.com/brunchboy/park"
